...
wget  https://github.com/WebPremiumAI/aiweb2/raw/Premium/Instalador/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget  https://github.com/WebPremiumAI/aiweb2/raw/Premium/Instalador/verifatt.sh > /dev/null 2>&1
wget  https://github.com/WebPremiumAI/aiweb2/raw/Premium/Instalador/verpweb > /dev/null 2>&1
wget  https://github.com/WebPremiumAI/aiweb2/raw/Premium/Instalador/verweb > /dev/null 2>&1
...
wget  https://github.com/WebPremiumAI/aiweb2/raw/Premium/Instalador/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "raw.githubusercontent.com/WebPremiumAI/aiweb2/Premium/Instalador/chave") &>/dev/null
