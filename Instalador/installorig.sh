...
wget bitbucket.org/nandoslayer/install/downloads/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget bitbucket.org/nandoslayer/install/downloads/verifatt.sh > /dev/null 2>&1
wget bitbucket.org/nandoslayer/install/downloads/verpweb > /dev/null 2>&1
wget bitbucket.org/nandoslayer/install/downloads/verweb > /dev/null 2>&1
...
wget bitbucket.org/nandoslayer/install/downloads/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "bitbucket.org/nandoslayer/install/downloads/chave") &>/dev/null
