...
IP=$(wget -qO- ipv4.icanhazip.com)
clear
echo -e "\E[44;1;37m    ATUALIZANDO O PAINEL WEB GESTOR-SSH MODO COMPATÍVEL COM ARM     \E[0m"
echo ""
...
wget https://github.com/nandoslayer/pweb/raw/painel/install/gestorssharm.zip > /dev/null 2>&1
sleep 1
